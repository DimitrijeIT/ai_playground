...
# Tokenize input
input_sentence = "Despite the rain, the children decided to go outside and play."  # Example input sentence
# input_sentence = "After finishing his homework, John went to the park."
# input_sentence = "The cat sits on the mat."
input_sentence = "Artificial intelligence is transforming many industries."
