...
class RevertButtom(ctk.CTkButton):
...
class SaveButtom(ctk.CTkButton):
    def __init__(self, parent, export_image, name_string, file_string, path_string):
        ...
        self.pack_string = path_string

    def save(self):
        self.export_image(self.name_string.get(), self.file_string.get(), self.path_sting.get())
...
class FilePathPanel(Panel):
    def __init__(self, parent, path_sting):
        super().__init__(parent= parent)
        self.path_string = path_sting
