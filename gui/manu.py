...
class Menu(ctk.CTkTabview):
    def __init__(self, parent, pos_vars, color_vars, effect_vars, export_image):
        ...
        self.grid(row = 0, column = 0, sticky = 'nswe', padx = 10, pady = 10)
...
class ColorFrame(ctk.CTkFrame):
    def __init__(self, parent, color_vars):
        ...
        RevertButtom(self,
                    (color_vars['brightness'], BRIGHTNESS_DEAFULT), 
                    (color_vars['grayscale'], GRAYSACELE_DEFATULT), 
                    (color_vars['invert'], INVERT_DEFATULT), 
...
class ExportFrame(ctk.CTkFrame):
    def __init__(self, parent, export_image):
        ...
        SaveButtom(self, export_image, self.name_string, self.file_string, self.path_string)
